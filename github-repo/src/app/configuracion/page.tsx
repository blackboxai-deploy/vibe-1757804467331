   ...
   const handleLogoUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      if (!file.type.startsWith('image/')) {
        alert('Por favor seleccione un archivo de imagen válido (PNG, JPG, GIF)')
        return
      }
            ...
            {activeTab === 'empresa' && (
              <form onSubmit={handleSaveEmpresa} className="space-y-6">
                ...
                <div className="bg-blue-50 p-6 rounded-lg border border-blue-200">
                  <h4 className="text-lg font-semibold text-blue-900 mb-4">🖼️ Logo de la Empresa</h4>
                        ...
                        {configEmpresa.logoEmpresa ? (
                          <div className="text-center">
                            ...
                            <div className="mt-3 space-y-1">
                              <p className="text-sm font-medium text-gray-900">
                                {configEmpresa.logoWidth} × {configEmpresa.logoHeight} px
                              </p>
                              <button
                                type="button"
                          ...
                          <div className="text-center py-8 text-gray-400">
                            ...
                            <p className="text-xs">El logo aparecerá aquí cuando lo suba</p>
                          </div>
                        )}
                      </div>
